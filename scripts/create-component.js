...
rl.question('What is the name of the component? ', (componentName) => {
    fs.readdir('src/components', { withFileTypes: true }, (err, files) => {
        ...
        rl.question(`Select the parent component directory? \n${directories
            ...
            if (selectedIndex === directories.length - 1) {
                ...
                if (fs.existsSync(componentPath)) {
                    ...
                    fs.writeFileSync(`${componentPath}/${componentName}.story.vue`, `<script setup lang="ts">\nimport '@/index.css';\n</script>`);
                    fs.appendFileSync(`${componentPath}/index.ts`, `export { default as ${componentName} } from './${componentName}.vue';\n`);
